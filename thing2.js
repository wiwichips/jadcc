...
const isWorkFun = false;

const SYSROOT_WINJ_BYTES = Buffer.from(WINJ_EMBED_FILE_AS_BIN('./sysroot.tar'), 'base64');
const CLANG_WINJ_BYTES   = Buffer.from(WINJ_EMBED_FILE_AS_BIN('./clang'),       'base64');
const MEMFS_WINJ_BYTES   = Buffer.from(WINJ_EMBED_FILE_AS_BIN('./memfs'),       'base64');
...
// helper function convert nodejs Buffer to JS ArrayBuffer
...
async function compile () {
  ...
  function hostWrite(s) { console.log(s); }
